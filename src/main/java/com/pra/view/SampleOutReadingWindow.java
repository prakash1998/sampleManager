...
import com.pra.controller.SampleOutReadingController;
...
@Component
public class SampleOutReadingWindow extends BaseEntityWindow<SampleOutReading, SampleOutReadingController> {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SampleOutReadingWindow frame = new SampleOutReadingWindow();
